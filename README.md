...
I'm a passionate Software Engineer who loves building modern, scalable web applications and automation-first platforms.  
I enjoy working on backend systems, frontend experiences, and cloud/devops workflows — turning ideas into real products.
...
- **Frameworks & Libraries:** Laravel, React, Vue.js, Next.js, Svelte.js  
...
💡 Skilled in building robust full-stack apps using **Laravel, Node.js, React, Vue, Next.js**, and automation solutions using modern tooling.

- 🧑‍🤝‍🧑 Open to collaborating on open source and exciting projects  
- 📚 Always learning and exploring new technologies  
- ⚡ Focused on performance, clean architecture, and scalable solutions  
